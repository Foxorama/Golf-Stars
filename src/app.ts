...
import { questBeatFor } from './sim/rpg/storyQuestBeat';
...
import { storyMidBeatScreen, storyQuestBeatScreen } from './app/storyMidroundScreens';
 ...
 *   • `?screen=travel|shop|starmart|trademarket|clubhouse|lore|storymidbeat|storyquestbeat|storyshop|storylocker|storyshipyard|shipinterior|storytournament|storyfinale|storychoice|storyinterlude|storybar` (GS-screen-deeplink) — mount a between-stop
