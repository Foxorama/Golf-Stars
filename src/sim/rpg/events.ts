...
export const ROUTE_EVENTS: readonly RouteEvent[] = [
...

  {
    id: 'radiant-bloom',
    label: 'Radiant Bloom',
    desc: 'Credits +20%. Still, golden light — the ball flies far and true.',
    lore: 'A young star flares wide and warm. The whole course glows; the air holds its breath.',
    icon: '☀️',
    category: 'payout',
    rarity: 'common',
    creditMult: 1.2,
  ...
  },
  {
    id: 'sunbath-drift',
    label: 'Sunbath Drift',
    desc: 'Cut −1. Bask in bright, dead-still air.',
    lore: 'You coast through a warm shaft of starlight. Nothing moves but you.',
    icon: '🌤️',
    category: 'calm',
    rarity: 'common',
    creditMult: 1,
  ...
  },
  {
    id: 'solar-wind',
    label: 'Solar Wind',
    desc: 'Credits +25% · cut +1. A stiff particle breeze runs the whole hole.',
    lore: 'The star exhales. A steady stream of charged particles streaks past the wagon.',
    icon: '🌬️',
    category: 'payout',
    rarity: 'rare',
    creditMult: 1.25,
  ...
  },
  {
    id: 'dust-storm',
    label: 'Dust Storm',
    desc: 'Credits +30% · cut +1. Grit that gusts AND drags — earn it.',
    lore: 'A rolling ochre wall swallows the horizon. The air turns to sandpaper.',
    icon: '🏜️',
    category: 'payout',
    rarity: 'rare',
    creditMult: 1.3,
  ...
  },
  {
    id: 'snow-squall',
    label: 'Snow Squall',
    desc: 'Credits +28% · cut +1. A driving flurry; ice underfoot.',
    lore: 'A sudden white gust barrels through, throwing snow flat across the fairway.',
    icon: '🌨️',
    category: 'payout',
    rarity: 'rare',
    creditMult: 1.28,
  ...
  },
  {
    id: 'blizzard',
    label: 'Blizzard',
    desc: 'Credits +45% · cut +2. A screaming whiteout gale, ice underfoot.',
    lore: 'The wagon vanishes into a wall of driven snow. You play by feel and faith.',
    icon: '🌨️',
    category: 'payout',
    rarity: 'epic',
    creditMult: 1.45,
  ...
  },
  {
    id: 'helios-gale',
    label: 'Helios Gale',
    desc: 'Credits +40% · cut +1. A relentless solar wind, dawn to dusk.',
    lore: 'The star roars its whole output past you in one long, unbroken stream.',
    icon: '🌬️',
    category: 'payout',
    rarity: 'epic',
    creditMult: 1.4,
  ...
  },
  {
    id: 'sirocco',
    label: 'Sirocco',
    desc: 'Credits +50% · cut +2. A furnace of grit that gusts and drags.',
    lore: 'A hot ochre tempest off some dead world, thick enough to lean on.',
    icon: '🏜️',
    category: 'toll',
    rarity: 'epic',
    creditMult: 1.5,
  ...
  {
    id: 'dark-matter-fog',
    label: 'Dark-Matter Fog',
    desc: 'Credits +55% · cut +2. Unseen mass stills the air; tar pools on the turf.',
    lore: 'The stars smear and bend. Something massive and invisible is out here with you.',
    icon: '🌑',
    category: 'toll',
    rarity: 'legendary',
    creditMult: 1.55,
  ...
  },
  {
    id: 'umbral-veil',
    label: 'Umbral Veil',
    desc: 'Credits +45% · cut +1. A dark-matter shroud drags the light down.',
    lore: 'A cold umbra drifts across the course, gravitic and utterly silent.',
    icon: '🌑',
    category: 'payout',
    rarity: 'epic',
    creditMult: 1.45,
