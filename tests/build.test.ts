...
describe('build output (real browser)', () => {
  ...
  const SCREENS: { screen: string; sel?: string; text?: string; label: string }[] = [
    ...
    { screen: 'storyheraldclub', sel: '.gs-sclub-scene--herald', text: 'Herald', label: 'the Herald (Coil) clubhouse variant' },
    { screen: 'storyheraldbar', sel: '.gs-pbar--herald', text: 'Carrion Prophet', label: 'the Herald Crow bar (the Coil bartender)' },
