...
const NEW: BiomeArchetype[] = ['crystal', 'tempest', 'fungal', 'ocean', 'cetus', 'swamp', 'metal', 'derelict'];
const NEW_BIOMES = ['crystal-spires', 'tempest-reach', 'spore-jungle', 'tidal-archipelago', 'cetus-deep', 'toxic-mire', 'scrap-belt', 'derelict-ship'];
