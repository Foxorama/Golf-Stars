...
<script type="module">
  ...
  for (const c of CASES) {
    ...
    fig.innerHTML = '<figcaption>' + c.effect + ' · ' + c.archetype + '</figcaption>';
    ...
    const w = createWeather({ effect: c.effect, width: 300, height: 460, archetype: c.archetype, windSpd: 18, windDir: [0.8, 0.6], seed: 1234567 });
